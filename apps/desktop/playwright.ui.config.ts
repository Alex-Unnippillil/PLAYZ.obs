...
export default defineConfig({
  ...
  workers: 2, retries: 0, timeout: 30000, globalTimeout: 180000,
  ...
  webServer: {
    // Own the Vite process directly, without a nested package-manager launcher.
    command: 'node node_modules/vite/bin/vite.js preview --host 127.0.0.1 --port 1420 --strictPort',
