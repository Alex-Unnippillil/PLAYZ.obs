...
if (@(Get-ObsExportNames -Lines @()).Count -ne 0) { throw 'Empty table accepted' }
Write-Output 'Export parser regression tests passed (plain, annotated, deduplicated, malformed, empty)'
